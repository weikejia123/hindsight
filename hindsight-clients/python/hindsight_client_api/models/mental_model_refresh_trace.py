...
class MentalModelRefreshTrace(BaseModel):
    ...
    scope: Optional[MentalModelRefreshScope] = None
    window: Optional[MentalModelRefreshWindow] = None
    facts: Optional[MentalModelFactCounts] = Field(default=None, description="Facts retrieved versus actually used.")
    ...
    __properties: ClassVar[List[str]] = ["recorded_at", "effective_mode", "mode_fallback_reason", "outcome", "scope", "window", "facts", "tool_calls", "llm_calls", "delta_operations", "usage", "duration_ms", "warnings"]
