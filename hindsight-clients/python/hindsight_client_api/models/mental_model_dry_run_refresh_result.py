...
class MentalModelDryRunRefreshResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["mental_model_id", "name", "requested_mode", "effective_mode", "mode_fallback_reason", "outcome", "would_persist", "scope", "window", "facts", "current_content", "candidate_content", "preview_content", "diff", "delta_operations", "trace", "usage", "duration_ms", "warnings"]
