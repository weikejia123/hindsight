...
func (o *MentalModelTriggerInput) GetTagGroups() []MentalModelRefreshOverridesTagGroupsInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *MentalModelTriggerInput) GetTagGroupsOk() ([]MentalModelRefreshOverridesTagGroupsInner, bool) {
...
func (o *MentalModelTriggerInput) SetTagGroups(v []MentalModelRefreshOverridesTagGroupsInner) {
	o.TagGroups = v
}
