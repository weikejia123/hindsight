...
from hindsight_api.engine.providers.openai_response_llm import OpenAIResponseLLM
...
def test_from_env_routes_to_openai_response_llm(monkeypatch):
    ...
    try:
        ...
        assert isinstance(llm._provider_impl, OpenAIResponseLLM)
    finally:
        clear_config_cache()
...
async def test_call_sends_reasoning_object_and_omits_temperature_for_reasoning_model():
    ...
    with patch("hindsight_api.engine.providers.openai_response_llm.get_metrics_collector"):
